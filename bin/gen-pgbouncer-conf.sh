...
PGBOUNCER_BUILD_DIR=${PGBOUNCER_BUILD_DIR:-'/app'}
n=1
...
cat >> ${PGBOUNCER_BUILD_DIR}/vendor/pgbouncer/pgbouncer.ini << EOFEOF
[pgbouncer]
listen_addr = 127.0.0.1
listen_port = 6000
auth_type = md5
auth_file = ${PGBOUNCER_BUILD_DIR}/vendor/pgbouncer/users.txt
...
do
  ...
  cat >> ${PGBOUNCER_BUILD_DIR}/vendor/pgbouncer/users.txt << EOFEOF
"$DB_USER" "$DB_MD5_PASS"
EOFEOF
...
chmod go-rwx ${PGBOUNCER_BUILD_DIR}/vendor/pgbouncer/*
